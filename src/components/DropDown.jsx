      ...
      >
        ...
        <div className="absolute right-5 size-3 flex items-center justify-center">
          ...
          <span className={`
            ...
            ${isOpen ? "-translate-y-1 translate-x-0" : "translate-y-0 -translate-x-1   group-hover:-translate-y-1 group-hover:translate-x-0 "}
          `}></span>
        ...
        <div className="pt-1 pb-3 flex flex-col gap-1  ">
          ...
          >
            <div className="px-4   flex flex-col transition-transform duration-500 hover:-translate-y-1/2">
              <span className=" p-3 text-black hover:bg-blue-100 rounded-full transition-colors">
              About
            </span>
            <span className=" p-3 mb-3 text-black hover:bg-blue-100 rounded-full transition-colors">
              About
            </span>
            </div>
